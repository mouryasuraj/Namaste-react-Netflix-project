...
const Login = () => {
    ...
    const handleForm = (e) => {
        ...
        e.preventDefault()
        // validate form
        const message = checkValidate(!isSignInForm && name.current.value, email.current.value, password.current.value, form)
            ...
            <div className='absolute top-0 w-full'>
                ...
                <div className='sm:max-w-[500px] mx-auto sm:px-16 sm:py-12 px-5 mt-6 relative rounded-md bg-black bg-opacity-75'>
                    ...
                    <form onSubmit={handleForm} className='flex flex-col'>
                        ...
                        <p className='my-3 text-red-500 font-semibold text-[15px]'>{errorMessage}</p>
